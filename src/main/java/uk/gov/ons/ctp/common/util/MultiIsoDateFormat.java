...
/**
 * This class is intended to be used as the default means for parsing and formatting dates in RM service
 * requests/responses.  It allows a number of different ISO8601 formats and aims to be compatible with the
 * Python ISO8601 format
 */
